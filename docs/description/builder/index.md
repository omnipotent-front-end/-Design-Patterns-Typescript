...
生成器模式建议**将对象构造代码从产品类中抽取出来， 并将其放在一个名为_生成器_的独立对象中**。

![](2020-04-23-14-28-44.png)

生成器模式让你能够**分步骤创建复杂对象**。 生成器不允许其他对象访问正在创建中的产品。
...
生成器模式让你可以**分步骤生成对象， 而且允许你仅使用必须的步骤**。 应用该模式后， 你再也**不需要将几十个参数塞进构造函数**里了。
